...
public class OrderOutboxRepositoryImpl implements OrderOutboxRepository {
    ...
    @Override
    public Optional<OrderOutboxMessage> findByTypeAndSagaIdAndPaymentStatusAndOutboxStatus(String sagaType, UUID sagaId, PaymentStatus paymentStatus, OutboxStatus outboxStatus) {
