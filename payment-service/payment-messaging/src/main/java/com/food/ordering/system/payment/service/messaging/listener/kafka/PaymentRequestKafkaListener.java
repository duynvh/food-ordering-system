...
public class PaymentRequestKafkaListener implements KafkaConsumer<PaymentRequestAvroModel> {
    ...
    public void receive(@Payload List<PaymentRequestAvroModel> messages,
        ...
        messages.forEach(paymentRequestAvroModel -> {
            ...
            // Can't have version for optimistic lock like in order-service because is possible for updates, here I just save, so I have a constraint on the database index to not have duplicates
            catch (DataAccessException e) {
                //NO-OP for unique constraint exception to avoid retry
