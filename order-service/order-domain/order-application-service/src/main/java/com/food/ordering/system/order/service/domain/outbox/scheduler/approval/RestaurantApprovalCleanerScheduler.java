...
@Slf4j
@Component
public class RestaurantApprovalCleanerScheduler implements OutboxScheduler {
    private final ApprovalOutboxHelper approvalOutboxHelper;

    public RestaurantApprovalCleanerScheduler(ApprovalOutboxHelper approvalOutboxHelper) {
