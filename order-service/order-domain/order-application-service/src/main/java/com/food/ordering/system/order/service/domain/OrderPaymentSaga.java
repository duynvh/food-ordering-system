...
public class OrderPaymentSaga implements SagaStep<PaymentResponse> {
    ...
    public void process(PaymentResponse paymentResponse) {
        Optional<OrderPaymentOutboxMessage> orderPaymentOutboxMessageResponse =
         ...
         ANOTHER TRANSACTION UPDATED THIS DATA AND WILL BE NOT COMMITTED (THAT'S THE ROLE OF @√ERSION IN ENTITY)
         */
        ...
        approvalOutboxHelper.saveApprovalOutboxMessage(
                orderDataMapper.orderPaidEventToOrderPaymentEventPayload(domainEvent),
    ...
    private OrderApprovalOutboxMessage getUpdatedApprovalOutboxMessage(String sagaId,
        ...
        orderApprovalOutboxMessage.setProcessAt(ZonedDateTime.now(ZoneId.of(UTC)));
